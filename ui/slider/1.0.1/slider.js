    ...
    $.fn.slider = function(options) {
        ...
        function addslider(eslider) {
            ...
            function setCurrent() {
                ...
                var imgSrcStart = curItem.attr("style").indexOf("url"),
                    imgSrcEnd = curItem.attr("style").length - 2;
                if(imgSrcStart > -1){
                    var imgSrc = curItem.attr("style").substring(imgSrcStart + 4, imgSrcEnd);
                    jImgBlur.css({
